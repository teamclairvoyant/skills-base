...
public class LoggingAspect {
    ...
    //email - ([a-zA-Z0-9!#$'*+?^_`{|}~.-]+(?:@|%40)(?:[a-zA-Z0-9-]+\.)+[a-zA-Z0-9-]+)
    //password -
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Started Execution: {}.{}() with argument[s] = {}", joinPoint.getSignature().getDeclaringTypeName(),
                    joinPoint.getSignature().getName(), Arrays.toString(joinPoint.getArgs()));
        }
        try {
            Object result = joinPoint.proceed();
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("Execution Completed: {}.{}() with result = {}", joinPoint.getSignature().getDeclaringTypeName(),
